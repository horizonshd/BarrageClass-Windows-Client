...
namespace BarrageClass
{
    ...
    public class BarrageUIBlock : FrameworkElement
    {
        public static readonly DependencyProperty FillProperty = DependencyProperty.Register(
            "Fill",
            typeof(Brush),
            typeof(BarrageUIBlock),
        ...
        {
            var BarrageUIBlock = (BarrageUIBlock)dependencyObject;
            BarrageUIBlock.formattedText = null;
            BarrageUIBlock.textGeometry = null;

            BarrageUIBlock.InvalidateMeasure();
            BarrageUIBlock.InvalidateVisual();
        }

        private static void OnFormattedTextUpdated(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            var BarrageUIBlock = (BarrageUIBlock)dependencyObject;
            BarrageUIBlock.UpdateFormattedText();
            BarrageUIBlock.textGeometry = null;
